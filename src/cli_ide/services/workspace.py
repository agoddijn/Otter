...
class WorkspaceService:
    ...
    async def run_tests(
        ...
        raise NotImplementedError("Stub: run_tests")
    ...
    async def trace_execution(
        ...
        raise NotImplementedError("Stub: trace_execution")

    async def mark_position(self, name: str) -> None:
        raise NotImplementedError("Stub: mark_position")

    async def diff_since_mark(self, name: str) -> WorkspaceDiff:
        raise NotImplementedError("Stub: diff_since_mark")

    async def vim_command(self, command: str) -> str:
        raise NotImplementedError("Stub: vim_command")

    async def shell(
        self, command: str, working_dir: Optional[str] = None
    ) -> ShellResult:
        raise NotImplementedError("Stub: shell")
